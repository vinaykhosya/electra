...
# --- FASTAPI APPLICATION ---
app = FastAPI(
    title="Electra_AI Proxy",
    description="A simple API that forwards requests directly to the Electra_AI model.",
    version="1.0.0"
)
...
def ask_ollama_stream(request: OllamaRequest):
    ...
    # --- PROMPT WITH PERSONA ---
    # This prompt instructs the AI to act as Electra_AI.
    prompt_with_persona = f"""
    You are Electra_AI, a helpful and creative culinary assistant integrated into the ElectraWireless smart home app.
...
if __name__ == "__main__":
    print(f"--- Starting Electra_AI Streaming Server ---")
